...
import zipkin.autoconfigure.storage.sumo.ZipkinSumoStorageAutoConfiguration;

import static org.springframework.boot.test.util.EnvironmentTestUtils.addEnvironment;

public class ZipkinSumoStorageAutoConfigurationTest {
  ...
  public void doesntProvidesStorageComponent_whenStorageTypeNotCassandra() {
    ...
    context.register(PropertyPlaceholderAutoConfiguration.class,
      ZipkinSumoStorageAutoConfiguration.class);
    context.refresh();
